...
# 定义允许访问的源列表
origins = [
    "http://localhost:5173",  # Vue dev server (localhost)
...
if __name__ == "__main__":
    ...
    print(f"🌍 Chat服务即将启动于 http://{host}:{port}")
